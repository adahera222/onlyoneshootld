function Level7() {
    ...
    this.targets = [new Target(200, 100, [100, 400], 150), new Target(300, 300, [100, 400], 150), new Target(400, 100, [100, 400], 150), new Target(150, 100, [100, 400], 250)];
    ...
    this.update = function (dt) {
        ...
        if (this.targets.length == 0) {
            if (current_lvl == 7) scene = new Win;
            else scene = new Good;
            mouse.clicked = false;
        }
    ...
    this.draw = function (ctx) {
        ...
        ctx.fillText('LEVEL 7', game_width / 2, 48);
        ctx.restore();
